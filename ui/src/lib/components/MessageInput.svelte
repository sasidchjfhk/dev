<script>
  ...
  async function handleSendMessage() {
    ...
    let searchEngine = localStorage.getItem("selectedSearchEngine") || "google";
    ...
    // Set default search engine if none selected
    if (!searchEngine || searchEngine === "select search engine") {
      searchEngine = "google";
